    ...
    <main className="blog-page">
      ...
      <section className="blog-hero">
        <div className="blog-hero-content">
          ...
          <p>
            Practical study tips, student guides, productivity ideas,
            and useful resources to help you get the most out of your
            academic journey.
          </p>
        </div>
      </section>
      ...
      <section className="blog-newsletter">
        <div>
          ...
          <h2>Get useful study tips in your inbox.</h2>
